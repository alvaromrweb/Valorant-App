...
export default function Match({match}) {
    ...
    return  (
        <>
        <article 
                className={`w-full min-h-[7.2rem] border-l-8 rounded py-4 px-5 flex flex-wrap justify-between items-center gap-3 md:gap-5 relative cursor-pointer transition ${getStylesForMatch(match, isWizen)}`} 
